function [] = DHMM_Classifier_ergodic( pathname )
...
%             display('K means called for trainMat')
        ...
        %    display('K means finished')
            ...
            [A1, B1, pi1] = DHMM_parameters_ergodic(trainmat1, N, M);
            %A1
            %%%For class 2%%%
            %display('2 start')
            display('DHMM parameters called for trainMat2')
            [A2, B2, pi2] = DHMM_parameters_ergodic(trainmat2, N, M);
            %%%For class 3%%%
            %display('3rd start')
...
%             end
            ...
            [A3, B3, pi3] = DHMM_parameters_ergodic(trainmat3, N, M);
            %display('3rd ends')
