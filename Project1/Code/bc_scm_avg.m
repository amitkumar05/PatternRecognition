...
%calculated by taking average of covariance matrices of '3' individual classes
function [] = bc_scm_avg( pathname )
...
%    profile on;
    ...
    covmat = avg_mat( covmat1, covmat2, covmat3 );
    ...
    filename = [pathname '\probT1_bc_scm_avg.txt'];
    writemat(filename, probT1);
    filename = [pathname '\probT2_bc_scm_avg.txt'];
    writemat(filename, probT2);
    filename = [pathname '\probT3_bc_scm_avg.txt'];
    ...
    t='\bf Bayes Classifier with same covariance matrices(using average)';
    l1='Class 1';
    l2='Class 2';
    l3='Class 3';
...
%    axis ([-30 30 -30 30]);
    axis ([-500 2000 -500 2000]);
    print([pathname '\bc_scm_avg_class13'], '-dpng', '-r0');

    
    %%%Confusion Matrix%%%
    con_mat = con_mat_gen( probT1, probT2, probT3 );
    filename = [pathname '\con_mat_bc_scm_avg.txt'];
