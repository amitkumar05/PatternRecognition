...
%calculated by taking average of covariance matrices of '2' individual classes
function [] = bc_scm_avg_2( pathname )
    ...
    covmat = avg_mat( covmat1, covmat2 );
...
%    pixel = pixel_gen(-4, 4, 0.01, -4, 4, 0.01);
    ...
    axis ([-30 30 -30 30]);
%    axis ([-4 4 -4 4]);
    print([pathname '\bc_scm_avg_2_allclass'], '-dpng', '-r0');
