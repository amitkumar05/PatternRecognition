...
%calculated by finding covariance matrix of training data of '2' individual classes combined
function [  ] = bc_scm_2( pathname )
    ...
    t='\bf Bayes Classifier with same covariance matrices';
    l1='Class 1';
    l2='Class 2';
...
%    pixel = pixel_gen(-4, 4, 0.01, -4, 4, 0.01);
    ...
    axis ([-30 30 -30 30]);
%    axis ([-4 4 -4 4]);
    print([pathname '\bc_scm_2_allclass'], '-dpng', '-r0');
