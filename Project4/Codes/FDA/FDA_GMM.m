function [ ] = FDA_GMM( pathname,K ) %%K-> no of clusters
...
[probT1_C12,probT2_C12,probT3_C12]=GMM_2class_3test_FDA(tr1_proj12,tr2_proj12,te1_proj12,te2_proj12,te3_proj12,1,2,K);


[tr1_proj13,tr3_proj13,te1_proj13,te2_proj13,te3_proj13]=FDA_Aux(tr1,tr3,te1,te2,te3);
[probT1_C13,probT2_C13,probT3_C13]=GMM_2class_3test_FDA(tr1_proj13,tr3_proj13,te1_proj13,te2_proj13,te3_proj13,1,3,K);


[tr2_proj23,tr3_proj23,te1_proj23,te2_proj23,te3_proj23]=FDA_Aux(tr2,tr3,te1,te2,te3);
[probT1_C23,probT2_C23,probT3_C23]=GMM_2class_3test_FDA(tr2_proj23,tr3_proj23,te1_proj23,te2_proj23,te3_proj23,2,3,K);

%%% For test matrix of class 1 %%%
for k=1:size(te1,1)
    if(probT1_C12(k,2)==1 && probT1_C13(k,2)==1)
        probT1_C12(k,2)=1;
    elseif(probT1_C12(k,2)==2 && probT1_C23(k,2)==2)
        probT1_C12(k,2)=2;
    elseif(probT1_C13(k,2)==3 && probT1_C23(k,2)==3)
        probT1_C12(k,2)=3;
    else
        probT1_C12(k,2)=randi([1,3]);
    end
end

%%% For test matrix of class 2 %%%
for k=1:size(te2,1)
    if(probT2_C12(k,2)==1 && probT2_C13(k,2)==1)
        probT2_C12(k,2)=1;
    elseif(probT2_C12(k,2)==2 && probT2_C23(k,2)==2)
        probT2_C12(k,2)=2;
    elseif(probT2_C13(k,2)==3 && probT2_C23(k,2)==3)
        probT2_C12(k,2)=3;
    else
        probT2_C12(k,2)=randi([1,3]);
    end
end

%%% For test matrix of class 3 %%%
for k=1:size(te3,1)
    if(probT3_C12(k,2)==1 && probT3_C13(k,2)==1)
        probT3_C12(k,2)=1;
    elseif(probT3_C12(k,2)==2 && probT3_C23(k,2)==2)
        probT3_C12(k,2)=2;
    elseif(probT3_C13(k,2)==3 && probT3_C23(k,2)==3)
        probT3_C12(k,2)=3;
    else
        probT3_C12(k,2)=randi([1,3]);
    end
end

%%%Confusion Matrix%%%
con_mat = con_mat_gen_FDA_GMM( probT1_C12, probT2_C12,probT3_C12 );
filename = [pathname '\con_mat_FDA_GMM_cluster_' num2str(K) '.txt'];
